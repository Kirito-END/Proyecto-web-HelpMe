    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="#about">¿Qué es Help Me?</a>
            <ul>
          ...
          <div class="col-lg-10 col-md-6 mx-auto">
            <div class="about-content">
              ...
              <ul>
                ...
                <li><i class="ion-android-checkmark-circle"></i>Ayudar a las personas en estado de abandono.</li>
